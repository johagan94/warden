...
SEARCH_SETTINGS_SCHEMA: SchemaMap = {
    ...
    "http_retry_backoff_seconds": {"default": 1, "type": int, "min_value": 0},
    "http_retry_total": {"default": 2, "type": int, "min_value": 0},
...
CLEANUP_SETTINGS_SCHEMA: SchemaMap = {
    ...
    "max_cleanup_queue_pages": {"default": 100, "type": int, "min_value": 1},
